          ...
          children: [
            ...
            GlassCard(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Enviar mensagem', style: Theme.of(context).textTheme.titleLarge),
                      ...
                      return SizedBox(
                        ...
                        child: Center(
                          child: PillButton(
                            ...
                            loading: sending,
                            onTap: (_canSubmit && !sending) ? _submit : null,
                          ),
                        ),
                      );
                    },
  ...
  Widget build(BuildContext context) {
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        labelText: label,
        prefixIcon:
            Icon(icon, color: hasError ? AppColors.danger : AppColors.textMuted, size: 18),
        errorText: errorText,
        errorStyle: const TextStyle(color: AppColors.danger, fontSize: 12),
        enabledBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(AppRadius.md),
          borderSide: BorderSide(
            color: hasError ? AppColors.danger.withValues(alpha: 0.6) : AppColors.hairline,
          ),
        ),
